...
app.post("/booking", (req, res) => {
  ...
  const result = `FH${last_two_digits}${last_postal_two_digit}${random_number}`;
  ...
  submitBookingData.flightData.data[0].itineraries.forEach(
    (itinerary, itineraryIndex) => {
      itinerary.segments.forEach((segment, segmentIndex) => {
        ...
        <td style="padding: 8px; border: 1px solid #000; color: #000;"><img src="https://cmsrepository.com/static/flights/flight/airlinelogo-png/${itinerary.segments[0].carrierCode.toLowerCase()}.png" style="width:50px" /></td>
          ...
          <td style="padding: 8px; border: 1px solid #000; color: #000;">
            ${
              submitBookingData.flightData.data[0].travelerPricings[0]
                .fareDetailsBySegment[0].cabin || "N/A"
            }
          </td>ee
          <td style="padding: 8px; border: 1px solid #000; color: #000;">
          ${itinerary.duration
    ...
    <div style="background: #fff; font-size: 14px;">
		<div class="tem-section">
			...
			<div class="book-para">
				...
				<p>
					If any query please contact our customer support at <a ><b style="color:#048c9b;">${phoneNumberweb}</b></a> or send us an email at <a ><b style="color:#048c9b;">${email}</b></a> and one of our travel expert will be pleased to assist you.In Such unlikely event, if your tickets cannot be processed for any reason you will be notified via email or by telephone and your payment will NOT be processed.
				</p>
			</div>
